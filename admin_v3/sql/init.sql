...
CREATE TABLE `cta_unified_margin_rebalance` (
  ...
  `buy_mode` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'cash' COMMENT '底仓买入模式',
  `margin_side_effect_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '统一账户杠杆买入方式',
  ...
  `last_borrow_asset` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '最近借款资产',
  ...
  `base_wallet_source` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'MARGIN_OR_SPOT' COMMENT '底仓钱包来源',
